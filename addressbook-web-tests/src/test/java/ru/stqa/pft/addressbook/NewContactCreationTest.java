...
public class NewContactCreationTest {
  ...
  public void testNewContactCreation() {
    gotoAddNew();
    fillAddNewFormContact(new ContactData("Alex", "Alexbond", "Title", "Education", "new adress", "12345"));
  ...
  private void inputAddNewFormContact() {
    wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
  }

  private void fillAddNewFormContact(ContactData contactData) {
